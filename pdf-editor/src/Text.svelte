...
{#if operation}
	<Toolbar>
		...
		>
			...
			<button on:click={onDelete} class="w-5 h-5 rounded-full bg-white cursor-pointer">
...
<div use:tapout on:tapout={onBlur} class="absolute left-0 top-0 select-none" style="transform: translate({x + dx}px, {y + dy}px);">
	<div
		use:pannable
